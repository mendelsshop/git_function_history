...
Use the latest [crates.io](https://crates.io/crates/git_function_history) (also beta) by putting `git_function_history = "0.5.3"` in your cargo.toml under `[dependencies]` section.
